...
def get_package(Matrix):
    ...
    if len(packagelist) == 0:
        print("The list is empty please enter a valid Package")
        get_package(Matrix)
...
def admin_menu():
    print()
    print("$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$")
    print("Admin Menu entered - choose one of the following options:")
    print("$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$")
    print()
    print("1. Add city.")
    print("2. Edit table.")
    ...
    print()
    menu_choice = (input("Enter number here: "))
    ...
    if menu_choice == "1":
        ...
        print("Invalid value entered please enter another option.")
        admin_menu()
    admin_menu()
